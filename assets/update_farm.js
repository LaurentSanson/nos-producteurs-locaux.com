...
class Map
{
    ...
    select(address)
    {
        ...
        $("#farm_address_postCode").val(address.zipCode);
    ...
    search(e)
    {
        fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${e.currentTarget.value}&key=${process.env.GOOGLE_MAPS_API_KEY}`, {
            method: 'get',
            headers: {
